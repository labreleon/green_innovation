...
quadro_societario <- quadro_societario[,population:= NULL]
...
patent <- patent[is.na(delta_00_20_patent_total_verde),delta_00_20_patent_total_verde:= 0]
...
conleyreg(delta_00_10_rais~ cont_shock_temp_00_10+cont_shock_precip_00_10+log_income+urban+alphabet_rate+state_code,250,data = final_data, lat = "lat", lon = "lon",unit = "mun_code")
...
conleyreg(delta_00_10_rais_verde~ cont_shock_temp_00_10+cont_shock_precip_00_10+urban+log_income+alphabet_rate+state_code,250,data = final_data, lat = "lat", lon = "lon",unit = "mun_code")
...
conleyreg(delta_00_10_rais_prop~ cont_shock_temp_00_10+cont_shock_precip_00_10+urban+log_income+alphabet_rate+state_code,250,data = final_data, lat = "lat", lon = "lon",unit = "mun_code")
...
###################################
conleyreg(delta_patent_prop_00_10~ cont_shock_temp_00_10+cont_shock_precip_00_10+urban+log_income+urban+alphabet_rate+state_code,250,data = final_data, lat = "lat", lon = "lon",unit = "mun_code")
