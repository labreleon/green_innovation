...
# Based on reg_firms_municipal_cluster.R specifications
# ============================================================================
#
...
base_dep_vars <- c("firmas_ativas", "firmas_verde", "prop_verde")
base_dep_labels <- c("Total Firms", "Green Firms", "Prop. Green Firms")
...
save(results_clustered, results_hac,
     file = "./output/placebo_tests/firms_lagged_outcome_placebo_municipal_cluster.RData")

write.csv(results_clustered,
          file = "./output/placebo_tests/firms_lagged_outcome_placebo_municipal_cluster_clustered.csv",
          row.names = FALSE)

write.csv(results_hac,
          file = "./output/placebo_tests/firms_lagged_outcome_placebo_municipal_cluster_hac.csv",
          row.names = FALSE)

cat("\nResults saved to:\n")
cat("  - ./output/placebo_tests/firms_lagged_outcome_placebo_municipal_cluster.RData\n")
cat("  - ./output/placebo_tests/firms_lagged_outcome_placebo_municipal_cluster_clustered.csv\n")
cat("  - ./output/placebo_tests/firms_lagged_outcome_placebo_municipal_cluster_hac.csv\n")
cat("\nScript completed.\n")
