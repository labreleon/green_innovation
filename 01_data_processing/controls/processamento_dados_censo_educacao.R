...
setnames(censo_escolar, c("id_municipio", "ano"), c("municipality_code", "year"))
setnames(censo_ensino_superior, c("id_municipio", "ano"), c("municipality_code", "year"))

# Salvar dados processados em arquivos CSV
fwrite(censo_escolar, "./output/Censo_da_educacao_basica.csv", row.names = FALSE)
fwrite(censo_ensino_superior, "./output/Censo_do_ensino_superior.csv", row.names = FALSE)
